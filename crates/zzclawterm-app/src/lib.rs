//! Bundled assets for the ZzClawTerm shell.
//!
...
mod tests {
    ...
    fn multilingual_i18n_preload_does_not_use_the_callers_small_stack() {
        let preload = std::thread::Builder::new()
            .name("zzclawterm-i18n-small-stack-test".to_string())
            .stack_size(256 * 1024)
            .spawn(zzclawterm_desktop::preload_i18n)
        ...
        assert!(
            zzclawterm_desktop::preload_i18n().is_ok(),

...
These fixtures freeze the Tauri (`temp/zzclawterm-tauri`, read-only reference) to GPUI
(`zzclawterm-core`) AI behaviour baseline. They are consumed by
`crates/zzclawterm-core/tests/ai_parity.rs`.

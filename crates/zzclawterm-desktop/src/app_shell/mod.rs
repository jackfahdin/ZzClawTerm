...
use zzclawterm_ui::{
    ...
    ZzClawPaste, ZzClawRedo, ZzClawSelectAll, ZzClawUndo,
};
...
impl AppShell {
    pub fn new(
        ...
        // ZzClawTermApp entity, and ZzClawTermApp already cx.notify()s on visual dirty.
    ...
    fn update_app(
        &self,
        cx: &mut Context<Self>,
        update: impl FnOnce(&mut ZzClawTermApp, &mut Context<ZzClawTermApp>),
    ) {
        if let Some(app) = &self.app {
    ...
    fn export_recovery_diagnostics(&mut self, cx: &mut Context<Self>) {
        let output_path = self
            .runtime
            .log_dir()
            .join("zzclawterm-recovery-diagnostics.zip");
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .flex_col()
                            .gap_3()
                            .child(div().text_xl().child("ZzClawTerm could not load its data"))
                            .child(
                                div()
                                    .text_sm()
                            ...
                            .child(
                                div()
                                    ...
                                    .gap_2()
                                    .child(
                                        ZzClawButton::new("recovery-retry", "Retry")
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                div()
                                    .text_xl()
                                    .child("ZzClawTerm could not save all changes"),
                            )
                            .child(
                                div()
                                    .text_sm()
                            ...
                            .child(
                                div().text_sm().text_color(rgb(0xd6a85f)).child(
                                    "Force Quit will discard changes that could not be saved.",
                                ),
                            )
                            .child(
                                div()
                                    ...
                                    .child(
                                        ZzClawButton::new("shutdown-return", "Return to App")
                                            .on_click(cx.listener(|this, _, _, cx| {
...
fn native_app_menus() -> Vec<Menu> {
    vec![
        ...
        Menu::new("Edit").items([
            MenuItem::os_action("Undo", ZzClawUndo, OsAction::Undo),
            MenuItem::os_action("Redo", ZzClawRedo, OsAction::Redo),
            MenuItem::separator(),
            MenuItem::os_action("Cut", ZzClawCut, OsAction::Cut),
            MenuItem::os_action("Copy", ZzClawCopy, OsAction::Copy),
            MenuItem::os_action("Paste", ZzClawPaste, OsAction::Paste),
            MenuItem::os_action("Select All", ZzClawSelectAll, OsAction::SelectAll),
        ]),
        Menu::new("View").items([
...
mod tests {
    ...
    fn native_menu_keeps_tauri_macos_top_level_order() {
        ...
        assert_eq!(
            menu_names(&menus),
            ["ZzClawTerm", "File", "Edit", "View", "Terminal", "Help"]
        );
    }

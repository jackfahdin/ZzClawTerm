...
use zzclawterm_core::{QuickCommandCategory, uuid};
use zzclawterm_store::{StoreDomain, store_request};
use zzclawterm_ui::{ZzClawConfirmDialog, ZzClawDialogFooter, ZzClawDialogWindowExt};
    ...
    pub(in crate::features) fn open_delete_quick_command_confirm(
        ...
        window.open_nya_dialog(cx, move |dialog, _, _| {
            ...
            ZzClawConfirmDialog::new(
                ...
                ZzClawDialogFooter::new(cancel_label.clone(), delete_label.clone()).danger(),
            )

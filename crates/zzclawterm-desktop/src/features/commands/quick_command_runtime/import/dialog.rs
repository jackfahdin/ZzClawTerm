...
use zzclawterm_core::export_quick_commands_json;
use zzclawterm_store::{StorageError, StoreDomain};
...
impl ZzClawTermApp {
    ...
    pub(in crate::features) fn prompt_quick_command_export(&mut self, cx: &mut Context<Self>) {
        ...
        let receiver = cx.prompt_for_new_path(&directory, Some("zzclawterm-quick-commands.json"));

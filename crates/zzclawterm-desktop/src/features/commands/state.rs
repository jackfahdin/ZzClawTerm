...
use zzclawterm_store::StoreBlockingClient;
...
impl CommandFeatureState {
    ...
    pub(in crate::features) fn quick_editor_window(&self) -> Option<ZzClawWindowHandle> {
...
mod tests {
    ...
    use zzclawterm_core::{QuickCommand, QuickCommandCategory};
    ...
    fn move_quick_category_by_one_reorders_and_stops_at_the_ends() {
        ...
        let order = |state: &CommandFeatureState| {
            zzclawterm_core::quick_command_category_sibling_order(

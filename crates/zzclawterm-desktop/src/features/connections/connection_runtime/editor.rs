...
impl ZzClawTermApp {
    ...
    fn connection_editor_validation_message(
        ...
        use zzclawterm_transport::{SshAlgorithmListKind, SshAlgorithmValidationError};
        ...
        match error {
            ...
            ConnectionEditorValidationError::SshAgentEndpoint(error) => match error {
                zzclawterm_core::SshAgentEndpointValidationError::Empty => {
                    t!("dialog.sshAgentEndpointEmpty").into()
                }
                zzclawterm_core::SshAgentEndpointValidationError::Invalid => {
                    t!("dialog.sshAgentEndpointInvalid").into()
                }
                zzclawterm_core::SshAgentEndpointValidationError::TooLong => {
                    t!("dialog.sshAgentEndpointTooLong").into()
                }
                zzclawterm_core::SshAgentEndpointValidationError::DuplicateEndpoint => {
                    t!("dialog.sshAgentEndpointDuplicate").into()
                }
                zzclawterm_core::SshAgentEndpointValidationError::TooManyEndpoints
                | zzclawterm_core::SshAgentEndpointValidationError::TooManyIdentities
                | zzclawterm_core::SshAgentEndpointValidationError::InvalidFingerprint
                | zzclawterm_core::SshAgentEndpointValidationError::DuplicateFingerprint => {
                    t!("dialog.sshAgentEndpointInvalid").into()
                }
            },
    ...
    pub(in crate::features) fn open_connection_editor(
        ...
        let editor = if let Some(connection_id) = connection_id {
            ...
            ConnectionEditorState {
                ...
                agent_forwarding_config: zzclawterm_core::SshAgentForwardingConfig::default(),
            ...
            && !editor.agent_allow_all_confirmed
        {
            self.open_confirm_dialog(
                (
                    ...
                    true,
                    |this: &mut ZzClawTermApp, window, cx| {

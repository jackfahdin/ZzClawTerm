...
pub(super) enum ConnectionEditorValidationError {
    ...
    SshAlgorithms(zzclawterm_transport::SshAlgorithmValidationError),
}
...
pub(super) fn build_saved_connection_from_editor(
        ...
        ConnectionKindTab::Ssh => {
            ...
            ConnectionType::Ssh {
                ...
                agent_forwarding_config: (editor.agent_forwarding_config
                    != zzclawterm_core::SshAgentForwardingConfig::default())
    ...
    let ssh_algorithms = if editor.kind == ConnectionKindTab::Ssh {
        ...
        let transport_preferences =
            preferences.as_ref().map(
                |preferences| zzclawterm_transport::SshAlgorithmPreferences {
                    mode: match preferences.mode {
                        SshAlgorithmMode::Compatible => {
                            zzclawterm_transport::SshAlgorithmMode::Compatible
                        }
        ...
        zzclawterm_transport::validate_ssh_algorithm_preferences(transport_preferences.as_ref())
    ...
    fn connection_editor_round_trip_preserves_ssh_encoding_sftp_and_algorithms() {
        ...
        assert_eq!(
            ...
            ConnectionEditorValidationError::SshAlgorithms(
                zzclawterm_transport::SshAlgorithmValidationError::Unsupported {
                    kind: zzclawterm_transport::SshAlgorithmListKind::KeyExchange,

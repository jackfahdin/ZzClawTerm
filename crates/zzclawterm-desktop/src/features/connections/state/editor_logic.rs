...
use zzclawterm_ui::ChildWindowSlot;
    ...
    match select {
        ...
        ConnectionEditorSelect::SshAgentEndpoint => {
            editor.agent_endpoint = match value.as_deref() {
                Some("environment") => zzclawterm_core::SshAgentEndpoint::Environment {
                    variable: "SSH_AUTH_SOCK".to_string(),
                },
                Some("pageant") => zzclawterm_core::SshAgentEndpoint::Pageant,
                Some("windows_openssh") => zzclawterm_core::SshAgentEndpoint::WindowsOpenSsh,
                Some("unix_socket") => zzclawterm_core::SshAgentEndpoint::UnixSocket {
                    path: String::new(),
                },
                _ => zzclawterm_core::SshAgentEndpoint::Auto,
            };
        }
        ConnectionEditorSelect::SshAgentForwardingPolicy => {
            editor.agent_forwarding_config.policy = match value.as_deref() {
                Some("all") => {
                    ...
                    zzclawterm_core::SshAgentForwardingPolicy::All
                }
                _ => zzclawterm_core::SshAgentForwardingPolicy::Allowlist {
                    fingerprints: match &editor.agent_forwarding_config.policy {
                        zzclawterm_core::SshAgentForwardingPolicy::Allowlist { fingerprints } => {
                            fingerprints.clone()
                        }
                        zzclawterm_core::SshAgentForwardingPolicy::All => Vec::new(),
                    },
                },
            };
        }
        ...
        ConnectionEditorSelect::SshAlgorithmMode => {
            ...
            if mode == "custom" {
                let defaults = &zzclawterm_transport::supported_ssh_algorithms().compatible;
        ...
        ConnectionEditorSelect::SshProfile => {
            editor.ssh_profile = match value.as_deref() {
                Some("network_device") => zzclawterm_core::SshProfile::NetworkDevice,
                _ => zzclawterm_core::SshProfile::Standard,
            };
        }
        ConnectionEditorSelect::SshTerminalType => {
            editor.terminal_type = match value.as_deref() {
                Some("xterm-256color") => Some(zzclawterm_core::SshTerminalType::Xterm256Color),
                Some("xterm") => Some(zzclawterm_core::SshTerminalType::Xterm),
                Some("vt100") => Some(zzclawterm_core::SshTerminalType::Vt100),
                Some("vt220") => Some(zzclawterm_core::SshTerminalType::Vt220),
                Some("ansi") => Some(zzclawterm_core::SshTerminalType::Ansi),
                Some("linux") => Some(zzclawterm_core::SshTerminalType::Linux),
                _ => None,
            };
        }
        ...
        ConnectionEditorSelect::RecordingMode => {
            ...
            recording.mode = Some(if value.as_deref() == Some("raw") {
                zzclawterm_core::RecordingMode::Raw
            } else {
                zzclawterm_core::RecordingMode::Transcript
            });
        }
...
pub(super) fn add_connection_editor_agent_endpoint(
    ...
    if editor
        ...
        .len()
        >= zzclawterm_core::MAX_SSH_AGENT_FORWARDING_ENDPOINTS
    {
        return false;
    }
    editor
        ...
        .sources
        .external_agent_endpoints
        .push(zzclawterm_core::SshAgentEndpoint::Auto);
...
pub(super) fn set_connection_editor_agent_endpoint_type(
    ...
    *endpoint = match value {
        "environment" => zzclawterm_core::SshAgentEndpoint::Environment {
            variable: "SSH_AUTH_SOCK".to_string(),
        },
        "unix_socket" => zzclawterm_core::SshAgentEndpoint::UnixSocket {
            path: String::new(),
        },
        "pageant" => zzclawterm_core::SshAgentEndpoint::Pageant,
        "windows_openssh" => zzclawterm_core::SshAgentEndpoint::WindowsOpenSsh,
        _ => zzclawterm_core::SshAgentEndpoint::Auto,
    };
    editor.agent_forwarding_endpoint_index = index;
    editor.error = None;
...
pub(super) fn toggle_connection_editor_agent_allowlist_fingerprint(
    ...
    let zzclawterm_core::SshAgentForwardingPolicy::Allowlist { fingerprints } =
    ...
    } else if fingerprints.len() < zzclawterm_core::MAX_SSH_AGENT_FORWARDING_IDENTITIES {
...
fn default_ssh_agent_forwarding_endpoint() -> zzclawterm_core::SshAgentEndpoint {
    #[cfg(windows)]
    {
        zzclawterm_core::SshAgentEndpoint::WindowsOpenSsh
    }
    #[cfg(not(windows))]
    {
        zzclawterm_core::SshAgentEndpoint::Environment {
            variable: "SSH_AUTH_SOCK".to_string(),
        }
    }
}
    ...
    vec![
        ...
        (
            ...
            match &draft.agent_endpoint {
                zzclawterm_core::SshAgentEndpoint::Environment { variable } => variable.clone(),
        ...
        (
            ...
            match &draft.agent_endpoint {
                zzclawterm_core::SshAgentEndpoint::UnixSocket { path } => path.clone(),
                _ => String::new(),
            },
            false,
...
pub(super) fn forwarding_endpoint_field_seeds(
    ...
    draft
        ...
        .filter_map(|(index, endpoint)| match endpoint {
            zzclawterm_core::SshAgentEndpoint::Environment { variable } => Some((
                index,
                ConnectionEditorField::AgentForwardingEnvironmentVariable,
                variable.clone(),
                "SSH_AUTH_SOCK",
            )),
            zzclawterm_core::SshAgentEndpoint::UnixSocket { path } => Some((
                index,
                ConnectionEditorField::AgentForwardingSocketPath,
                path.clone(),
                "/path/to/agent.sock",
...
pub(super) fn set_connection_editor_forwarding_endpoint_field(
    ...
    *endpoint = match field {
        ConnectionEditorField::AgentForwardingEnvironmentVariable => {
            zzclawterm_core::SshAgentEndpoint::Environment { variable: text }
        }
        ConnectionEditorField::AgentForwardingSocketPath => {
            zzclawterm_core::SshAgentEndpoint::UnixSocket { path: text }
        }
        _ => return false,
    };
    editor.error = None;
...
fn selected_forwarding_endpoint(
    draft: &ConnectionEditorState,
) -> Option<&zzclawterm_core::SshAgentEndpoint> {
    draft
        .agent_forwarding_config
        .sources
        .external_agent_endpoints
...
fn forwarding_environment_variable(draft: &ConnectionEditorState) -> String {
    match selected_forwarding_endpoint(draft) {
        Some(zzclawterm_core::SshAgentEndpoint::Environment { variable }) => variable.clone(),
        _ => "SSH_AUTH_SOCK".to_string(),
    }
}
...
fn forwarding_socket_path(draft: &ConnectionEditorState) -> String {
    match selected_forwarding_endpoint(draft) {
        Some(zzclawterm_core::SshAgentEndpoint::UnixSocket { path }) => path.clone(),
        _ => String::new(),
    }
}
...
pub(super) fn set_connection_editor_field_text(
    ...
    match field {
        ...
        ConnectionEditorField::AgentEnvironmentVariable => {
            draft.agent_endpoint =
                zzclawterm_core::SshAgentEndpoint::Environment { variable: text };
        }
        ConnectionEditorField::AgentUnixSocket => {
            draft.agent_endpoint = zzclawterm_core::SshAgentEndpoint::UnixSocket { path: text };
        }
        ConnectionEditorField::AgentForwardingEnvironmentVariable => {
            ...
            {
                *endpoint = zzclawterm_core::SshAgentEndpoint::Environment { variable: text };
            }
        }
        ConnectionEditorField::AgentForwardingSocketPath => {
            if let Some(endpoint) = draft
                ...
                .get_mut(draft.agent_forwarding_endpoint_index)
            {
                *endpoint = zzclawterm_core::SshAgentEndpoint::UnixSocket { path: text };
            }
        }

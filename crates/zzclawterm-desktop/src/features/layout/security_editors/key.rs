...
use zzclawterm_ui::{ZzClawScrollable, ZzClawTabItem, ZzClawTabs};
                    ...
                    .when_else(
                        ...
                        |this| {
                            if let Some(error) = error {
                                ...
                                this.child(zzclawterm_ui::ZzClawSelectableText::new(
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                div().w(px(160.)).child(
                                    ZzClawTabs::new("security-key-material-mode")
                                        .items([
                                            ZzClawTabItem::new(t!("settings.keyInputContentMode"))
                                                .disabled(self.security.editor_busy()),
                                            ZzClawTabItem::new(t!("settings.keyInputFileMode"))
                                                .disabled(self.security.editor_busy()),
                                        ])
                    ...
                    div()
                        ...
                        .child(
                            div()
                                ...
                                .child(
                                    div().w(px(160.)).child(
                                        ZzClawTabs::new("security-cert-material-mode")
                                            .items([
                                                ZzClawTabItem::new(t!(
                                                    "settings.keyInputContentMode"
                                                ))
                                                .disabled(self.security.editor_busy()),
                                                ZzClawTabItem::new(t!("settings.keyInputFileMode"))
                                                    .disabled(self.security.editor_busy()),

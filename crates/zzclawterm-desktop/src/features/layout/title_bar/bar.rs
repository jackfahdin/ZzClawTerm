...
use crate::features::{
    ZzClawTermApp, formatting::format_rate, formatting::format_uptime, formatting::short_id,
...
impl ZzClawTermApp {
    ...
    fn header_status_control(
        ...
        let mut items = HeaderStatusMode::ALL
            .into_iter()
            .map(|mode| {
                zzclawterm_ui::ZzClawMenuItem::action(t!(mode.i18n_key()))
            ...
            .collect::<Vec<_>>();
        items.extend([
            zzclawterm_ui::ZzClawMenuItem::separator(),
            zzclawterm_ui::ZzClawMenuItem::action(t!("headerStatus.hide"))
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .child(
                        ZzClawDropdownMenu::new("header-status-menu-trigger")

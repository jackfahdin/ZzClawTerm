...
impl ZzClawTermApp {
    ...
    fn title_file_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
        vec![
            ...
            ZzClawMenuItem::action(t!("settings.importConfig"))
    ...
    fn title_view_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
        ...
        vec![
            ZzClawMenuItem::submenu(t!("menu.theme"), self.title_theme_menu_items(cx))
            ...
            ZzClawMenuItem::submenu(t!("menu.language"), self.title_language_menu_items(cx))
    ...
    fn title_terminal_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
        vec![
            ZzClawMenuItem::action(t!("menu.commandPalette"))
            ...
            ZzClawMenuItem::submenu(t!("menu.smartSplit"), self.title_smart_split_menu_items(cx))
                .icon("icons/menu/split.svg"),
            ZzClawMenuItem::separator(),
            ZzClawMenuItem::submenu(t!("menu.syncInput"), self.title_sync_input_menu_items(cx))
                .icon("icons/sync.svg"),
            ZzClawMenuItem::separator(),
            ZzClawMenuItem::action(t!("menu.broadcastToAll"))
            ...
            ZzClawMenuItem::separator(),
            ZzClawMenuItem::action(t!("menu.clearTerminal"))
    ...
    fn title_help_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
        ...
        vec![
            ...
            ZzClawMenuItem::separator(),
            ZzClawMenuItem::action(format!("{} ZzClawTerm", t!("menu.about")))
                .icon("icons/menu/info.svg")
                .on_click(cx.listener(|this, _, window, cx| {
    ...
    fn title_theme_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
        ...
        crate::theme::APPEARANCE_THEME_IDS
            ...
            .map(|&theme| {
                ...
                ZzClawMenuItem::action(crate::theme::appearance_theme_label(theme))
                    .checked(selected)
    ...
    fn title_terminal_theme_menu_items(
        ...
        let mut items = vec![
            ZzClawMenuItem::action(t!("settings.followUiTheme"))
    ...
    fn title_language_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
    ...
    fn title_header_status_menu_items(
        ...
        let mut items = vec![
            ZzClawMenuItem::action(t!("headerStatus.hidden"))
                .checked(!visible)
                .on_click(cx.listener(|this, _, window, cx| {
        ...
        items.extend(HeaderStatusMode::ALL.into_iter().map(|mode| {
            ZzClawMenuItem::action(t!(mode.i18n_key()))
    ...
    fn title_panels_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
        let floating = self.shell.panel_open_mode().is_floating();
        let multi_open = self.shell.panel_multi_open();
        vec![
            ZzClawMenuItem::action(t!("panel.floatingMode"))
                .checked(floating)
                .on_click(cx.listener(move |this, _, _, cx| {
            ...
            ZzClawMenuItem::action(t!("panel.multiOpen"))
                .checked(multi_open)
                .on_click(cx.listener(|this, _, _, cx| {
            ...
            ZzClawMenuItem::separator(),
            ZzClawMenuItem::action(t!("activityBar.resetLayout"))
                .danger()
                .on_click(cx.listener(|this, _, window, cx| {
    ...
    fn title_side_panel_menu_items(
        ...
        let entries = zones
            ...
            .collect::<Vec<_>>();
        if entries.is_empty() {
            return vec![ZzClawMenuItem::action(t!("activityBar.noPanels")).disabled(true)];
        }
        entries
            .into_iter()
    ...
    fn title_terminal_display_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
        vec![
            ZzClawMenuItem::action(t!("settings.showWorkspacePadding"))
                .checked(self.settings.summary().terminal_show_workspace_padding)
                .on_click(cx.listener(|this, _, _, cx| {
                    this.toggle_terminal_workspace_padding(cx);
                })),
            ZzClawMenuItem::action(t!("settings.showLineNumbers"))
                .checked(self.settings.summary().terminal_show_line_numbers)
                .on_click(cx.listener(|this, _, _, cx| {
                    this.toggle_terminal_line_numbers(cx);
                })),
            ZzClawMenuItem::action(t!("settings.showTimestamps"))
    ...
    fn title_smart_split_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
        vec![
    ...
    fn title_sync_input_menu_items(&self, cx: &mut Context<Self>) -> Vec<ZzClawMenuItem> {
        vec![
            ZzClawMenuItem::action(t!("menu.manageGroups"))
...
mod tests {
    ...
    fn panels_submenu_exposes_independent_modes_and_dynamic_sides() {
        ...
        let left = submenu
            ...
            .and_then(ZzClawMenuItem::children)

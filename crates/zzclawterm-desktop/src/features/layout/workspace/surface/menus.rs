...
use zzclawterm_ui::{
    ZzClawPopover, ZzClawPopoverAlign, ZzClawPopoverPlacement, ZzClawScrollArea, ZzClawScrollable,
};
...
use zzclawterm_core::{ConnectionType, Group, SavedConnection, build_group_path, truncate_preview};
...
impl ZzClawTermApp {
    ...
    pub(in crate::features) fn render_new_session_menu(
        ...
        let all_sessions_popover = ZzClawPopover::new(
        ...
        div()
            ...
            .child(
                ZzClawScrollArea::new(SharedString::from(format!(
...
#[cfg(test)]
mod tests {
    use zzclawterm_core::{ConnectionType, Group, SavedConnection};

...
use zzclawterm_ui::ZzClawWindowHandle;
...
impl NotesFeatureState {
    ...
    pub fn editor_window(&self, note_id: &str) -> Option<ZzClawWindowHandle> {
    ...
    pub fn finish_editor_window(&mut self, note_id: String, handle: Option<ZzClawWindowHandle>) {
...
mod tests {
    ...
    use zzclawterm_core::{NoteFolder, NoteSummary, NoteTreePayload, NotesUiState};

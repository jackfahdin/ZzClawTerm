...
use crate::features::{
    ZzClawTermApp, icons::CONNECTION_ICON_OPTIONS, icons::DEFAULT_CONNECTION_ICON,
...
impl ZzClawTermApp {
    ...
    fn connection_editor_select_options(
        choices: &[ConnectionEditorChoice],
    ) -> Vec<ZzClawSelectOption> {
        choices
            .iter()
            .map(|choice| {
                let mut option = ZzClawSelectOption::new(
                    choice
                        .value
                        .clone()
                        .unwrap_or_else(|| NO_SELECTION_VALUE.to_string()),
    ...
    pub(super) fn ssh_agent_endpoint_value(
        ...
        match endpoint {
            zzclawterm_core::SshAgentEndpoint::Auto => "auto",
            zzclawterm_core::SshAgentEndpoint::Environment { .. } => "environment",
            zzclawterm_core::SshAgentEndpoint::UnixSocket { .. } => "unix_socket",
            zzclawterm_core::SshAgentEndpoint::WindowsOpenSsh => "windows_openssh",
            zzclawterm_core::SshAgentEndpoint::Pageant => "pageant",
        }
    }
    ...
    pub(super) fn ssh_agent_endpoint_choices(
        ...
        if !zzclawterm_core::ssh_agent_endpoint_supported_on_current_platform(endpoint) {
            let label = match endpoint {
                zzclawterm_core::SshAgentEndpoint::Environment { .. } => {
                    t!("dialog.sshAgentEnvironment")
                }
                zzclawterm_core::SshAgentEndpoint::UnixSocket { .. } => {
                    t!("dialog.sshAgentUnixSocket")
                }
                zzclawterm_core::SshAgentEndpoint::Pageant => t!("dialog.sshAgentPageant"),
                zzclawterm_core::SshAgentEndpoint::WindowsOpenSsh => {
                    t!("dialog.sshAgentWindowsOpenSsh")
                }
                zzclawterm_core::SshAgentEndpoint::Auto => t!("dialog.sshAgentAuto"),
            };
    ...
    fn connection_editor_surface(
        ...
        .map(|(value, label)| {
            ConnectionEditorChoice::new(
                ...
                matches!(
                    ...
                    (zzclawterm_core::SshProfile::Standard, "standard")
                        | (zzclawterm_core::SshProfile::NetworkDevice, "network_device")
                ),
            )
        })
        .collect::<Vec<_>>();
        let effective_terminal =
            zzclawterm_core::resolve_ssh_terminal_type(editor.ssh_profile, editor.terminal_type);
        ...
        let recording_mode = editor
            ...
            .unwrap_or(zzclawterm_core::RecordingMode::Transcript);
        ...
        .map(|(value, label)| {
            ConnectionEditorChoice::new(
                ...
                matches!(
                    ...
                    (zzclawterm_core::RecordingMode::Transcript, "transcript")
                        | (zzclawterm_core::RecordingMode::Raw, "raw")
                ),
            )
        })
        .collect::<Vec<_>>();
        ...
        let policy_options = [
            ConnectionEditorChoice::new(
                ...
                matches!(
                    ...
                    zzclawterm_core::SshAgentForwardingPolicy::Allowlist { .. }
                ),
            ),
            ConnectionEditorChoice::new(
                Some("all".to_string()),
                ...
                div()
                    ...
                    .child(
                        ZzClawTabs::new("connection-kind-tabs")
                            .items([
                                ZzClawTabItem::new("SSH"),
                                ZzClawTabItem::new(local_label),
                                ZzClawTabItem::new("Telnet"),
                                ZzClawTabItem::new(serial_label),
                                ZzClawTabItem::new("RDP"),
                                ZzClawTabItem::new("VNC"),
                            ])
...
fn connection_editor_agent_identity_picker(
    ...
    let allowlist_fingerprints: &[String] = match &editor.agent_forwarding_config.policy {
        zzclawterm_core::SshAgentForwardingPolicy::Allowlist { fingerprints } => fingerprints,
        zzclawterm_core::SshAgentForwardingPolicy::All => &[],
    };
        ...
        for (index, identity) in preview.identities.iter().enumerate() {
            ...
            identity_list = identity_list.child(
                div()
                    ...
                    .gap_2()
                    .child(
                        ZzClawCheckbox::new(SharedString::from(format!(
            ...
            identity_list = identity_list.child(
                div()
                    ...
                    .child(format!(
                        ...
                        error.endpoint_type,
                        match error.code {
                            zzclawterm_transport::SshAgentEndpointPreviewErrorCode::ConnectFailed => {
                                t!("dialog.sshAgentEndpointConnectFailed")
                            }
                            zzclawterm_transport::SshAgentEndpointPreviewErrorCode::IdentityEnumerationFailed => {
    ...
    let picker_card = div()
        ...
        .child(
            ZzClawScrollArea::new("connection-agent-identity-picker-list")
                .max_h(px(320.))
                .child(identity_list),
        )
        .child(
                            ...
                            div()
                                ...
                                .child(
                                    div().flex_none().w_full().max_h(px(192.)).bg(rgb(
                                        ...
                                        ZzClawScrollArea::new("connection-editor-group-options")
                                            .max_h(px(192.))
    ...
    div()
        ...
        .child(
            div()
                ...
                .children(entity.map(ZzClawInput::new)),
        )
}

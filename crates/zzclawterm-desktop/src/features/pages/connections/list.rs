...
use rust_i18n::t;
use zzclawterm_core::{Group, SavedConnection, natural_compare};

use crate::features::{
    ZzClawTermApp, text_inputs::ORDINARY_INPUT_SHELL_PADDING_X_PX,
...
pub(super) struct ConnectionEditorRenderContext<'a, 'cx> {
    ...
    pub cx: &'a mut Context<'cx, ZzClawTermApp>,
}
    ...
    div()
        ...
        .child(
            div()
                ...
                .min_w_0()
                .child(ZzClawSelect::new(&fields.select(select))),
        )
}
    ...
    fn connection(
        ...
        SavedConnection {
            ...
            config: zzclawterm_core::ConnectionType::LocalTerminal {
                ...
                working_dir: None,
                ai_execution_profile: zzclawterm_core::AiExecutionProfile::Auto,
                encoding: String::new(),
...
pub(super) struct ConnectionEditorFields {
    ...
    selects: HashMap<ConnectionEditorSelect, Entity<ZzClawSelectState>>,
    forwarding_endpoint_selects: HashMap<usize, Entity<ZzClawSelectState>>,
...
impl ConnectionEditorFields {
    pub(super) fn new(
        ...
        selects: HashMap<ConnectionEditorSelect, Entity<ZzClawSelectState>>,
        forwarding_endpoint_selects: HashMap<usize, Entity<ZzClawSelectState>>,
        forwarding_endpoint_fields: HashMap<
            (usize, ConnectionEditorField),
    ...
    pub(super) fn get(&self, field: &ConnectionEditorField) -> Option<&Entity<ZzClawInputState>> {
    ...
    ) -> Option<&Entity<ZzClawNumberInputState>> {
        self.number_fields.get(field)
    }

    pub(super) fn select(&self, select: ConnectionEditorSelect) -> Entity<ZzClawSelectState> {
        self.selects
            .get(&select)
            .cloned()
    ...
    pub(super) fn forwarding_endpoint_select(&self, index: usize) -> Entity<ZzClawSelectState> {
            ...
            div()
                ...
                .children(entity.map(|field| {
                    div()
                        ...
                        .text_xs()
                        .text_color(rgb(palette.text))
                        .child(ZzClawNumberInput::new(field))
                })),
        )
}
...
pub(super) fn connection_detail_rows(
    ...
    let mut rows = match &connection.config {
        zzclawterm_core::ConnectionType::Ssh {
            host,
            port,
            username,
            ..
        ...
        zzclawterm_core::ConnectionType::LocalTerminal {
            shell_path,
            shell_args,
            working_dir,
            ..
        ...
        zzclawterm_core::ConnectionType::Telnet {
            host,
            port,
            username,
            ..
        ...
        zzclawterm_core::ConnectionType::Serial {
            port_name,
            baud_rate,
            data_bits,
            parity,
        ...
        zzclawterm_core::ConnectionType::Rdp {
            host,
            port,
            username,
            ..
        ...
        zzclawterm_core::ConnectionType::Vnc { host, port, .. } => vec![
            copyable_text_detail_row(t!("savedConnections.host").to_string(), host),
            copyable_value_detail_row(t!("savedConnections.port").to_string(), port.to_string()),
            ConnectionDetailRow::new(

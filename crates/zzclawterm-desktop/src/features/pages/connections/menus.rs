...
use gpui::Context;
use zzclawterm_core::SavedConnection;
use zzclawterm_ui::{ZzClawDialogWindowExt as _, ZzClawMenuItem};
...
impl ZzClawTermApp {
    fn connection_move_to_group_menu_items(
        ...
        let mut items = vec![
            ZzClawMenuItem::action(t!("savedConnections.ungroupedConnections"))
    ...
    pub(in crate::features::pages::connections) fn connection_context_menu_items(
        ...
        vec![
            ZzClawMenuItem::action(connect_label)
                .icon("icons/conn/connect.svg")
            ...
            ZzClawMenuItem::action(t!("savedConnections.edit"))
            ...
            ZzClawMenuItem::submenu(t!("savedConnections.moveToGroup"), move_items)
                .icon("icons/net/move.svg"),
            ZzClawMenuItem::separator(),
            ZzClawMenuItem::action(t!("savedConnections.delete"))
    ...
    pub(in crate::features::pages::connections) fn connection_group_context_menu_items(
        ...
        let mut items = vec![
            ZzClawMenuItem::action(t!("savedConnections.newConnection"))
            ...
            ZzClawMenuItem::action(t!("savedConnections.newFolder"))
        ...
        if total_in_group > 0 {
            items.extend([
                ZzClawMenuItem::separator(),
                ZzClawMenuItem::action(t!("savedConnections.openAllConnections"))
        ...
        items.extend([
            ZzClawMenuItem::separator(),
            ZzClawMenuItem::action(t!("savedConnections.renameFolder"))
                .icon("icons/session/rename.svg")
                .on_click(cx.listener(move |this, _, window, cx| {
                    this.open_connection_group_editor(
            ...
            ZzClawMenuItem::action(t!("savedConnections.deleteFolder"))
                .icon("icons/net/delete.svg")
                .danger()
                .on_click(cx.listener(move |this, _, window, cx| {
    ...
    fn connection_selected_menu_items(
        ...
        vec![
            ...
            ZzClawMenuItem::action(t!("savedConnections.copySelected"))
                .icon("icons/copy.svg")
    ...
    pub(in crate::features::pages::connections) fn connection_more_menu_items(
        ...
        if !self.connection_state.connections().is_empty() {
            items.extend([
                ZzClawMenuItem::separator(),
                ZzClawMenuItem::action(t!("savedConnections.clearAll"))

        ...
        div()
                        ...
                        div()
                            ...
                            .when(!master_password_switch_enabled, |this| {
                                this.tooltip(move |window, cx| {
                                    ZzClawTooltip::new(master_locked_desc.clone()).build(window, cx)
                                })
                            })
            ...
            .child(settings_form_section(
                ...
                self.settings_select_field(
                    ...
                    (
                        vec![
                            ZzClawSelectOption::new("strict", t!("settings.hostKeyStrict")),
                            ZzClawSelectOption::new("prompt", t!("settings.hostKeyPrompt")),
                            ZzClawSelectOption::new("accept", t!("settings.hostKeyAccept")),
                        ],
                        host_key_policy,
                        false,
                    ),

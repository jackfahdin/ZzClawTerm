...
impl SettingsPanel {
    pub(in crate::features) fn keyword_highlights_settings_section(
        ...
        let builtin_ids = zzclawterm_core::builtin_keyword_rule_ids();
                ...
                .child(
                        div()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .children(builtin_ids.iter().map(|id| {
                                                let id = (*id).to_string();
                                                let label =
                                                    zzclawterm_core::builtin_keyword_rule_label(&id);
                                                let swatch =
                                                    zzclawterm_core::builtin_keyword_rule_swatch(
                                                        &id, is_dark,
                                                    );
                                                let enabled = self
                            ...
                            .children(rules.into_iter().map(|rule| {
                                ...
                                let palette_dark = zzclawterm_core::keyword_highlight_color_palette(true);
                                let palette_light =
                                    zzclawterm_core::keyword_highlight_color_palette(false);

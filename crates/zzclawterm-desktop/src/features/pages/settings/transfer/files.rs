                    ...
                    .child(settings_form_row(
                        ...
                        self.settings_select_control(
                            ...
                            vec![
                                ...
                                ZzClawSelectOption::new("skip", t!("settings.strategySkip")),
                                ZzClawSelectOption::new("rename", t!("settings.strategyRename")),
                                ZzClawSelectOption::new("ask", t!("settings.strategyAsk")),
                            ],
                            selected_policy,
                            false,
                            cx,

...
use zzclawterm_core::{ExistingFileBehavior, RecordingMode, RecordingRotationPolicy};
                ...
                .child(settings_form_row(
                    ...
                    self.settings_select_control(
                        ...
                        vec![
                            ...
                            ZzClawSelectOption::new("raw", t!("settings.recordingModeRaw")),
                        ],
                        mode_value,
                        false,
                        cx,
                ...
                .child(settings_form_row(
                    ...
                    self.settings_select_control(
                        ...
                        vec![
                            ...
                            ZzClawSelectOption::new("daily", t!("settings.recordingRotationDaily")),
                            ZzClawSelectOption::new("size", t!("settings.recordingRotationSize")),
                        ],
                        rotation_value,
                        false,
                        cx,
                ...
                .child(settings_form_row(
                    ...
                    self.settings_select_control(
                        ...
                        vec![
                            ZzClawSelectOption::new(
                                "unique",
                                t!("settings.recordingExistingUnique"),
                            ),
                            ZzClawSelectOption::new(
                                "append",
                                t!("settings.recordingExistingAppend"),
                            ),
                            ZzClawSelectOption::new(
                                "overwrite",

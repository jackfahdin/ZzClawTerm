                ...
                div()
                    ...
                    .child(settings_form_row(
                        ...
                        self.settings_select_control(
                            ...
                            std::iter::once(ZzClawSelectOption::new(
                                "hidden",
                                t!("headerStatus.hidden"),
                            ))
                            .chain(HeaderStatusMode::ALL.into_iter().map(|mode| {
                                ZzClawSelectOption::new(mode.persistence_id(), t!(mode.i18n_key()))
                            }))
                            .collect(),
                            header_status_value,
                            false,
                ...
                div()
                    ...
                    .child(settings_form_row(
                        ...
                        self.settings_select_control(
                            ...
                            vec![
                                ZzClawSelectOption::new("warn", t!("settings.logLevelWarn")),
                                ZzClawSelectOption::new("info", t!("settings.logLevelInfo")),
                                ZzClawSelectOption::new("debug", t!("settings.logLevelDebug")),
                            ],
                            diagnostics_level,
                            false,
                            cx,

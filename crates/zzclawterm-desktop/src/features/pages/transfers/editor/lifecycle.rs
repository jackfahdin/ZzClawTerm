...
use zzclawterm_transport::{RemoteFilePath, RemoteTextGeneration, RemoteTextRevision};

use crate::features::{
    ZzClawTermApp, transfers::TransferEditorCloseAfterSave, transfers::TransferEditorCloseOutcome,

...
use zzclawterm_ui::ZzClawCheckbox;

use crate::features::{ZzClawTermApp, shell::gpui_code_font_family, text_inputs::TextInputSetup};
use crate::models::{
...
impl ZzClawTermApp {
    pub(in crate::features) fn transfer_new_folder_dialog_content(
        ...
        div()
            ...
            .child(
                ZzClawCheckbox::new("transfer-new-folder-open-after")
    ...
    pub(in crate::features) fn transfer_new_file_dialog_content(
        ...
        div()
            ...
            .child(
                ZzClawCheckbox::new("transfer-new-file-open-after")
                    .checked(state.open_after_create)
    ...
    pub(in crate::features) fn transfer_permission_grid(
        ...
        let toggle = move |id: &str, label: &str, mask: u32| {
            let app = app.clone();
            let checkbox = ZzClawCheckbox::new(id.to_string())
                .checked(mode & mask != 0)
                .on_click(move |_, _, cx| {
                    let _ = app.update(cx, |app, cx| {

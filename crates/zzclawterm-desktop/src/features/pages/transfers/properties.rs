...
use zzclawterm_transport::{RemoteFilePath, SftpAttributeUpdate, SftpFileEntry, SftpFileType};
...
impl ZzClawTermApp {
    ...
    pub(super) fn submit_transfer_properties(
        ...
        if properties.file_type == zzclawterm_transport::SftpFileType::Symlink {

...
use zzclawterm_transport::{SftpFileProperties, SftpFileType};
use zzclawterm_ui::{ZzClawCheckbox, ZzClawScrollable};

use crate::features::{ZzClawTermApp, text_inputs::TextInputSetup, transfers::format_file_size};
                    ...
                    .child(
                        div()
                            ...
                            .when(entry.is_directory(), |this| {
                                this.child(
                                    ZzClawCheckbox::new("transfer-properties-recursive")

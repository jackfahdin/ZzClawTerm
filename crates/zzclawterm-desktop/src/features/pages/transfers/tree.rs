...
use zzclawterm_ui::{
    ZzClawButton, ZzClawButtonVariant, ZzClawContextMenu, ZzClawUniformListScrollbar,
};
                            ...
                            range
                                ...
                                .map(|row| {
                                    ...
                                    let rename_input = is_renaming
                                        ...
                                        .flatten()
                                        .map(|field| {
                                            zzclawterm_ui::ZzClawInputShell::new(
                                    ...
                                    div()
                                            ...
                                            this.child(
                                                div()
                                                    ...
                                                    .tooltip(move |window, cx| {
                                                        zzclawterm_ui::ZzClawTooltip::new(error.clone())
                                                            .build(window, cx)
                                                    }),
                                            )
                                        })
                                        .when_some(hover_details, |this, details| {
                                            this.tooltip(move |window, cx| {
                                                zzclawterm_ui::ZzClawTooltip::new(details.clone())
                                                    .build(window, cx)
                                            })
                                        })
                                        .into_any_element()

...
use zzclawterm_core::{QuickCommand, QuickCommandCategory, quick_command_category_sibling_order};

use crate::features::{
    ZzClawTermApp, commands::quick_command_category_label, icons::quick_command_icon,

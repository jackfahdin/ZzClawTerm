...
impl ZzClawTermApp {
    ...
    fn quick_command_editor_surface(
        ...
        let category_list = ZzClawScrollArea::new("quick-command-editor-category-list")
            .max_h(px(258.))
        ...
        let category_picker = ZzClawPopover::new(
        ...
        let icon_picker_content = div()
            ...
            .shadow_lg()
            .child(icon_grid);
        let icon_picker = ZzClawPopover::new(
                        ...
                        div()
                                ...
                                div()
                                    ...
                                    .child(
                                        div()
                                            ...
                                            .child(
                                                ZzClawSwitch::new("quick-command-editor-pinned")
                            ...
                            .child(
                                div()
                                    ...
                                    .child(
                                        div().mt_2().child(
                                            ZzClawTabs::new("quick-command-editor-execution-mode")
                                                .variant(ZzClawTabsVariant::Segmented)
                                                .full_width(true)
                                                .items([
                                                    ZzClawTabItem::new(execute_label),
                                                    ZzClawTabItem::new(append_label),
                                                ])

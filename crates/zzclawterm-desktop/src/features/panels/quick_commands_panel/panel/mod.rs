...
use crate::features::{
    ZzClawTermApp, text_inputs::TextInputSetup, view_widgets::APP_OVERLAY_PRIORITY,
};
        ...
        div()
            ...
            .child(
                div()
                    ...
                    .overflow_hidden()
                    .child(zzclawterm_core::truncate_preview(&self.payload.label, 24)),
            )
    }
}
...
fn quick_command_sort_menu_button(
    ...
    ZzClawDropdownMenu::new("quick-command-sort")
...
fn quick_command_view_menu_button(
    ...
    ZzClawDropdownMenu::new("quick-command-view")
        .icon(icon_path)
        .icon_size(px(14.))
        .selected(true)
        .tooltip(format!(

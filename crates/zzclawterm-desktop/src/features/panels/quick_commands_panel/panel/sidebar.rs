...
use zzclawterm_ui::{ZzClawContextMenu, ZzClawMenuItem, ZzClawScrollable};

use super::super::super::QuickCommandCategoryOption;
use crate::features::{
    ZzClawTermApp, commands::QuickCommandDropPosition, commands::QuickCommandDropTarget,
};
...
impl ZzClawTermApp {
    ...
    fn quick_command_pseudo_category_menu_items(
        &self,
        cx: &mut Context<Self>,
    ) -> Vec<ZzClawMenuItem> {
        vec![
...
mod tests {
    ...
    use zzclawterm_core::{AppRuntime, QuickCommandCategory, RuntimeMode, uuid};
    ...
    fn group_menu_disables_the_move_that_would_leave_the_sibling_run() {
        ...
        let disabled = |app: &gpui::Entity<ZzClawTermApp>, cx: &mut TestAppContext, id: &str| {
            let items = cx.update_entity(app, |app, cx| {

...
use zzclawterm_transport::{RecordingMode, SessionInfo};
use zzclawterm_ui::{ZzClawScrollable, ZzClawSearchInput};
                ...
                div()
                    ...
                    .child(
                        div().relative().flex_1().min_w_0().child(
                            ZzClawSearchInput::new("recording-session-search", &search_field)

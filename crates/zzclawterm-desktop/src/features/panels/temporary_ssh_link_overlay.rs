            ...
            .child(
                div()
                    ...
                    .child(div().w(px(128.)).child(self.form_select_control(
                        ...
                        vec![
                            ZzClawSelectOption::new("ssh", t!("temporarySsh.protocolSsh")),
                            ZzClawSelectOption::new("telnet", t!("temporarySsh.protocolTelnet")),
                            ZzClawSelectOption::new("serial", t!("temporarySsh.protocolSerial")),
                        ],
                    ...
                    .child(div().min_w_0().flex_1().child(match protocol {
                        ...
                        TemporaryLinkProtocol::Serial => {
                            let serial_ports = self
                                ...
                                .serial_ports()
                                .iter()
                                .map(|port| ZzClawSelectOption::new(port.clone(), port.clone()))
                                .collect::<Vec<_>>();

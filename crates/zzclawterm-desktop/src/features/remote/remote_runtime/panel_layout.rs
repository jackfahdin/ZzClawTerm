...
mod tests {
    ...
    fn register_session(app: &mut ZzClawTermApp, session_id: &str, ssh: bool) {
        app.session.register_session_metadata(
            session_id,
            crate::models::SessionRuntimeMetadata {
                ssh_config: ssh.then(zzclawterm_transport::SshSessionConfig::default),
    ...
    fn a_session_switch_reconciles_remote_panel_demand_without_a_paint() {
        ...
        cx.update_entity(&app, |app, cx| {
            ...
            let gpu_polling = |app: &ZzClawTermApp, cx: &gpui::App| {
                app.remote_panels

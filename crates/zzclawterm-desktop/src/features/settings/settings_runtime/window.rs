...
impl ZzClawTermApp {
    ...
    pub(in crate::features) fn activate_settings_window(&mut self, cx: &mut Context<Self>) -> bool {
        ...
        activate_child_window(
            &cx.entity(),
            handle,
            |app: &mut ZzClawTermApp| Some(app.shell.settings_window_slot()),
            cx,
        );
        true
    }
...
fn open_settings_window_now_from_app(app: Entity<ZzClawTermApp>, cx: &mut App) {

...
use crate::features::{ZzClawTermApp, runtime_jobs::ActivitySide, view_widgets::mono_icon};
use crate::models::{
...
mod tests {
    ...
    fn test_app(cx: &mut TestAppContext, root: &Path) -> gpui::Entity<ZzClawTermApp> {
    ...
    fn hiding_an_active_panel_clears_its_side_and_removes_it_from_the_rail() {
        let test_dir = TestConfigDir::new("zzclawterm-activity-bar");

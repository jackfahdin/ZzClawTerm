...
use zzclawterm_core::{CloudSyncError, CloudSyncHistoryEntry, CloudSyncSettings, CloudSyncState};
...
struct GithubGistAuthFeatureState {
    ...
    /// Taken once by `ZzClawTermApp::start_github_gist_auth_event_drain`, which
...
impl CloudSyncFeatureState {
    ...
    /// worker thread `ZzClawTermApp::start_github_gist_auth` spawns alongside it.
    #[cfg(test)]

...
use zzclawterm_core::terminal::dynamic_title::sanitize_dynamic_title;
use zzclawterm_terminal::{TerminalClipboardLoad, TerminalEffects, TerminalSnapshot};
...
impl ZzClawTermApp {
    ...
    fn apply_terminal_output_frame(
        ...
        // Only chrome dirtiness bubbles to ZzClawTermApp full-shell notify.
        TerminalFrameApplyResult {
...
mod frame_event_queue_tests {
    ...
    use zzclawterm_terminal::TerminalEffects;
    ...
    fn output_frame(session_id: &str, revision: u64) -> TerminalFrameEvent {
        TerminalFrameEvent::Output(TerminalFrameOutputEvent {
            ...
            snapshot: Some(std::sync::Arc::new(
                zzclawterm_terminal::TerminalScreen::default().viewport_snapshot(0),
            )),
            action_links: None,
            ...
            snapshot_stats: zzclawterm_terminal::TerminalSnapshotBuildStats {
    ...
    fn snapshot_frame(session_id: &str, offset: usize) -> TerminalFrameEvent {
        TerminalFrameEvent::Snapshot(TerminalFrameSnapshotEvent {
            ...
            snapshot: std::sync::Arc::new(
                zzclawterm_terminal::TerminalScreen::default().viewport_snapshot(offset),
            ),
            action_links: None,
            revision: 1,

...
use rust_i18n::t;
use zzclawterm_core::terminal_input_fanout_status;
use zzclawterm_ui::{ZzClawDocumentEditorEvent, ZzClawDocumentEditorState};
    ...
    pub(in crate::features) fn paste_terminal_text(
            ...
            && is_multi_line_paste(&text)
        {
            ...
            let editor = cx.new(|cx| {
                ZzClawDocumentEditorState::new_with_placeholder(
                    window,
                    cx,
                    text,
            ...
            let subscription =
                cx.subscribe(&editor, |this, _, event: &ZzClawDocumentEditorEvent, cx| {
                    if matches!(event, ZzClawDocumentEditorEvent::Changed(_)) {
...
mod tests {
    ...
    fn bracketed_paste_wraps_wire_bytes_without_reencoding_body() {
        ...
        let wrapped = ZzClawTermApp::wrap_terminal_paste_wire_bytes_for_bracketed(&body, true);
    ...
    fn plain_paste_wire_bytes_are_body_only() {
        let body = b"plain";
        assert_eq!(
            ZzClawTermApp::wrap_terminal_paste_wire_bytes_for_bracketed(body, false),
            body
        );
    }
    ...
    fn every_paste_review_action_restores_terminal_focus() {
        let dir = TestConfigDir::new("zzclawterm-desktop-paste-review-focus");

    ...
    pub(in crate::features) fn handle_terminal_external_file_drop(
        ...
        match kind {
            Some(SessionKind::LocalPty) | None => {
                ...
                let text = zzclawterm_core::format_local_terminal_drop_input(&path_strings);
...
mod tests {
    ...
    fn app_for_resize(cx: &mut TestAppContext) -> gpui::Entity<ZzClawTermApp> {

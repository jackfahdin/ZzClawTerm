...
use crate::terminal::{TerminalBufferMatch, TerminalLineDecorations, ZzClawTerminalLayoutCache};
...
#[cfg(test)]
type TerminalSnapshotRowSlice = std::sync::Arc<zzclawterm_terminal::TerminalSnapshotRow>;
...
impl ZzClawTermApp {
    ...
    pub(in crate::features) fn ensure_terminal_surface(
        ...
        let layout_cache = self
            ...
            .unwrap_or_else(|| {
                std::sync::Arc::new(std::sync::Mutex::new(ZzClawTerminalLayoutCache::default()))
            });

...
use zzclawterm_core::TerminalViewportInsets;
use zzclawterm_terminal::TerminalSnapshot;
use zzclawterm_terminal_gpui::terminal_font_features;
...
impl ZzClawTermApp {
    pub(in crate::features) fn terminal_cell_size(&self) -> (f32, f32) {
        ...
        (
            cell_w,
            zzclawterm_core::terminal_snapped_cell_height(
                cell_h,
    ...
    pub(in crate::features) fn terminal_snapshot_row_for_session_viewport_row(
        &self,
        session_id: Option<&str>,
        snapshot: &zzclawterm_terminal::TerminalSnapshot,
...
mod tests {
    ...
    fn test_hit_test_snapshot() -> Arc<zzclawterm_terminal::TerminalSnapshot> {
    ...
    fn snapshot_row_mapping_anchors_viewport_rows_inside_retained_snapshot() {
        let mut screen = zzclawterm_terminal::TerminalScreen::default();

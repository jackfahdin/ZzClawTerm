...
mod tests {
    ...
    fn armed(app: &Entity<ZzClawTermApp>, cx: &mut gpui::App) -> bool {
    ...
    fn a_closed_browser_owns_no_clock() {
        let test_dir = TestConfigDir::new("zzclawterm-cwd-clock");
    ...
    ///
    /// Arming used to happen in `ZzClawTermApp::render`, which made a repaint the

...
impl RemoteTextEditor {
    pub(super) fn search_inputs(
        ...
        let subscription = cx.subscribe(&search, |this, _, event, cx| match event {
            ZzClawInputEvent::Changed(query) => {
                this.search_query = query.clone();
                this.active_match = 0;
                this.select_search_match(0, cx);
            }
            ZzClawInputEvent::Submitted(_) => this.select_search_match(1, cx),
        ...
        div()
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .min_w_0()
                            .h(px(32.))
                            .child(ZzClawInput::new(&self.search_input)),
                    )
                    ...
                    .child(
                        ZzClawButton::new("editor-search-prev", t!("documentEditor.previous"))
                            .small()
                            .on_click(
                    ...
                    .child(
                        ZzClawButton::new("editor-search-next", t!("documentEditor.next"))
                            .small()
                            .on_click(
                                cx.listener(|this, _, _, cx| this.select_search_match(1, cx)),
                            ),
            ...
            .child(
                div()
                    ...
                    .gap_2()
                    .child(
                        ZzClawCheckbox::new("editor-search-case")
                    ...
                    .child(
                        ZzClawCheckbox::new("editor-search-word")
                    ...
                    .child(
                        ZzClawCheckbox::new("editor-search-regex")
                    ...
                    div()
                        ...
                        .child(
                            div()
                                ...
                                .min_w_0()
                                .h(px(32.))
                                .child(ZzClawInput::new(&self.replace_input)),
                        )
                        .child(
                            ZzClawButton::new("editor-replace", t!("documentEditor.replace"))
                                .small()
                                .on_click(

...
use zzclawterm_transport::{SftpDuplicatePolicy, SftpFileEntry, SftpFileProperties};
...
struct TransferQueueState {
    ...
    /// Taken once by `ZzClawTermApp::start_transfer_event_drain`, which owns

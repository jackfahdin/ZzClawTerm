...
impl TransferFeatureState {
    ...
    pub(in crate::features) fn preview_window(&self) -> Option<ZzClawWindowHandle> {
    ...
    pub(in crate::features) fn finish_preview_window_open(&mut self, handle: ZzClawWindowHandle) {

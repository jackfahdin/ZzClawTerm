...
use zzclawterm_core::{ProxyConfig, ProxyGroup, TunnelConfig, TunnelGroup, uuid};
use zzclawterm_transport::{SshTunnelInfo, SshTunnelManager};
...
pub(in crate::features) struct TunnelFeatureState {
    ...
    /// Taken once by `ZzClawTermApp::start_tunnel_event_drain`, which owns
...
#[cfg(test)]
mod tests {
    use zzclawterm_core::{ProxyConfig, ProxyGroup, TunnelConfig, TunnelGroup};

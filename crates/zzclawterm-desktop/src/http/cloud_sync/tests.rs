...
use zzclawterm_core::WebdavSyncSettings;
...
fn webdav_url_joins_endpoint_root_and_sync_path() {
    let remote = NativeWebdavRemote::new(&WebdavSyncSettings {
        ...
        root: "/apps/zzclawterm/".to_string(),
        username: String::new(),
        password: None,
    })
    .expect("remote");
    ...
    assert_eq!(
        remote.url_for("/zzclawterm/sync/latest.redb"),
        "https://dav.example.com/remote.php/webdav/apps/zzclawterm/zzclawterm/sync/latest.redb"
    );
}
...
fn webdav_propfind_parser_uses_local_names_and_decodes_file_names() {
    let body = r#"<?xml version="1.0"?>
        <d:multistatus xmlns:d="DAV:">
          <d:response><d:href>/dav/zzclawterm/sync/snapshots/</d:href></d:response>
          <d:response><d:href>/dav/zzclawterm/sync/snapshots/rev%20one.redb.enc</d:href></d:response>
          <d:response><d:href>/dav/zzclawterm/sync/snapshots/ignored.txt</d:href></d:response>
          <response xmlns="DAV:"><href>/dav/zzclawterm/sync/snapshots/rev-two.redb.enc</href></response>
        </d:multistatus>"#;

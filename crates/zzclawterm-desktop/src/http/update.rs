...
use zzclawterm_core::{NativeUpdateInfo, parse_github_latest_release};

const UPDATE_TIMEOUT: Duration = Duration::from_secs(20);
const RELEASES_URL: &str = "https://api.github.com/repos/jackfahdin/ZzClawTerm/releases/latest";

//! GPUI presentation crate for ZzClawTerm.
...
/// ZzClawTerm's full multilingual catalog that initializer exceeds the default
    ...
    I18N_PRELOAD_RESULT
        .get_or_init(|| {
            std::thread::Builder::new()
                .name("zzclawterm-i18n-preload".to_string())

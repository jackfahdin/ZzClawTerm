...
impl ConnectionKindTab {
    ...
    pub(crate) fn from_connection_type(config: &zzclawterm_core::ConnectionType) -> Self {
        match config {
            zzclawterm_core::ConnectionType::Ssh { .. } => Self::Ssh,
            zzclawterm_core::ConnectionType::LocalTerminal { .. } => Self::Local,
            zzclawterm_core::ConnectionType::Telnet { .. } => Self::Telnet,
            zzclawterm_core::ConnectionType::Serial { .. } => Self::Serial,
            zzclawterm_core::ConnectionType::Rdp { .. } => Self::Rdp,
            zzclawterm_core::ConnectionType::Vnc { .. } => Self::Vnc,
        }
    }
}
...
pub(crate) struct ConnectionEditorState {
    ...
    pub(crate) rdp_security: zzclawterm_core::RdpSecuritySettings,
    pub(crate) rdp_display: zzclawterm_core::RdpDisplaySettings,
    pub(crate) rdp_clipboard: zzclawterm_core::RdpClipboardSettings,
    pub(crate) rdp_reconnect: zzclawterm_core::RdpReconnectSettings,
    pub(crate) rdp_advanced_tab: ConnectionEditorRdpTab,
    pub(crate) vnc_security: zzclawterm_core::VncSecuritySettings,
    pub(crate) vnc_display: zzclawterm_core::VncDisplaySettings,
    pub(crate) vnc_clipboard: zzclawterm_core::VncClipboardSettings,
    pub(crate) vnc_reconnect: zzclawterm_core::VncReconnectSettings,
    ...
    pub(crate) agent_forwarding_config: zzclawterm_core::SshAgentForwardingConfig,
    pub(crate) agent_allow_all_confirmed: bool,
    pub(crate) agent_forwarding_endpoint_index: usize,
    pub(crate) agent_preview: Option<zzclawterm_transport::SshAgentIdentityPreviewResponse>,
...
pub(crate) struct CredentialAutofillMatchPipeline {
    ...
    /// Taken once by `ZzClawTermApp::start_credential_autofill_match_drain`,
...
impl CredentialAutofillMatchPipeline {
    pub(crate) fn spawn() -> Self {
        ...
        let worker = thread::Builder::new()
            .name("zzclawterm-credential-autofill".to_string())

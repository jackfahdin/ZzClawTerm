...
use zzclawterm_core::DiagnosticsExportInfo;
use zzclawterm_store::ConfigBackupInfo;
...
pub(crate) enum GithubGistAuthEvent {
    ...
    Succeeded {
        access_token: zzclawterm_core::SecretString,
        gist_id: String,
        login: String,
    },
    Failed(String),
...
pub(crate) struct CloudSyncSecretDraft {
    pub(crate) webdav_password: zzclawterm_core::SecretString,
    pub(crate) s3_access_key_id: zzclawterm_core::SecretString,
    pub(crate) s3_secret_access_key: zzclawterm_core::SecretString,
    pub(crate) s3_session_token: zzclawterm_core::SecretString,
    pub(crate) google_drive_access_token: zzclawterm_core::SecretString,
    pub(crate) google_drive_refresh_token: zzclawterm_core::SecretString,
    pub(crate) google_drive_client_secret: zzclawterm_core::SecretString,
    pub(crate) onedrive_access_token: zzclawterm_core::SecretString,
    pub(crate) onedrive_refresh_token: zzclawterm_core::SecretString,
    pub(crate) onedrive_client_secret: zzclawterm_core::SecretString,
    pub(crate) aliyun_drive_access_token: zzclawterm_core::SecretString,
    pub(crate) aliyun_drive_refresh_token: zzclawterm_core::SecretString,
    pub(crate) aliyun_drive_client_secret: zzclawterm_core::SecretString,
    pub(crate) gitee_token: zzclawterm_core::SecretString,
    pub(crate) github_token: zzclawterm_core::SecretString,
}

#[derive(Clone, Default, PartialEq, Eq)]
pub(crate) struct TranslationSecretDraft {
    pub(crate) deepl_api_key: zzclawterm_core::SecretString,
    pub(crate) baidu_app_key: zzclawterm_core::SecretString,
    pub(crate) ali_app_key: zzclawterm_core::SecretString,
    pub(crate) youdao_app_key: zzclawterm_core::SecretString,
}
...
pub(crate) struct SnapshotPasswordPromptState {
    ...
    pub(crate) value: zzclawterm_core::SecretString,
}
...
pub(crate) struct CloudSyncConflictState {
    pub(crate) preview: zzclawterm_core::CloudConflictPreview,

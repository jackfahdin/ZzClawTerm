...
pub(crate) struct SecurityKeyEditorState {
    ...
    pub(crate) key_data: zzclawterm_core::SecretString,
    pub(crate) cert_file_path: String,
    pub(crate) cert_data: zzclawterm_core::SecretString,
    pub(crate) passphrase: zzclawterm_core::SecretString,
...
pub(crate) struct SecurityOtpEditorState {
    ...
    pub(crate) secret: zzclawterm_core::SecretString,

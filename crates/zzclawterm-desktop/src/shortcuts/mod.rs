...
pub(crate) const WORKSPACE_KEY_CONTEXT: &str = "ZzClawWorkspace";
...
pub(crate) const MODAL_KEY_CONTEXT: &str = "ZzClawModal";
...
impl ShortcutScope {
    fn context(self) -> Option<&'static str> {
        match self {
            Self::Global => None,
            Self::Workspace => Some("ZzClawWorkspace && !Dialog && !ZzClawModal && !ScreenLocked"),

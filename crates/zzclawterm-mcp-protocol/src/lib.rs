...
pub const MCP_TOOL_REGISTRY: &[McpToolDefinition] = &[
    McpToolDefinition {
        ...
        description: "Return scoped ZzClawTerm sessions and the optional active and default sessions.",
    ...
    McpToolDefinition {
        ...
        description: "Open a new ZzClawTerm terminal session from a saved connection.",
    ...
    McpToolDefinition {
        ...
        description: "Execute a command in an existing scoped ZzClawTerm terminal session.",
        access: CapabilityAccess::Write,
        requires_session: true,
        read_only_hint: false,
        destructive_hint: false,
    ...
    McpToolDefinition {
        ...
        description: "Delete a remote path using ZzClawTerm's existing delete semantics.",
...
pub fn validate_tool_result(name: &str, value: &Value) -> Result<(), ToolContractError> {
    ...
    match name {
        ...
        _ => contract_error(name, "unknown ZzClawTerm MCP tool"),
    }
}

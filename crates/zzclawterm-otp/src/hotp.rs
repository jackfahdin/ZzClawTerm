...
impl Hotp {
    ...
    ///
    /// ```rust
    /// use zzclawterm_otp::{Hotp, Algorithm, Secret};
    ///
    /// let hotp = Hotp::new(
    ///     Algorithm::SHA1,
    ///     "example".into(),
    ...
    /// # Example
    /// ```rust
    /// let mut hotp = zzclawterm_otp::Hotp::default();
    ...
    /// # Example
    /// ```rust
    /// let hotp = zzclawterm_otp::Hotp::default();
    ...
    /// # Example
    /// ```rust
    /// use zzclawterm_otp::{Totp, Algorithm, Secret};
    ///
    /// let totp = Totp::new(
    ///     Algorithm::SHA256,
    ///     "Example".into(),

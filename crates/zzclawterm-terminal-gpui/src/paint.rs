...
pub(super) fn terminal_keyword_exclusion_ranges(
    _row: Option<&zzclawterm_terminal::TerminalSnapshotRow>,
...
mod tests {
    ...
    ) -> Vec<zzclawterm_terminal::StyledSpan> {
        vec![zzclawterm_terminal::StyledSpan {
            text: text.to_string(),
            style,
        }]
    ...
    fn keyword_ranges_preserve_ansi_underline() {
        let palette = zzclawterm_ui::theme_palette("github-dark");
        let style = zzclawterm_terminal::CellStyle {
            underline: true,
    ...
    fn keyword_ranges_do_not_override_explicit_or_hidden_ansi_text() {
        let palette = zzclawterm_ui::theme_palette("github-dark");
        let explicit = zzclawterm_terminal::CellStyle {
        ...
        let hidden = zzclawterm_terminal::CellStyle {

...
#[derive(Clone, Default)]
pub struct ZzClawTermEventProxy {
    events: Arc<Mutex<Vec<Event>>>,
}

impl ZzClawTermEventProxy {
...
impl EventListener for ZzClawTermEventProxy {
...
pub struct TerminalCore {
    ...
    term_config: Config,
    proxy: ZzClawTermEventProxy,
    sidecar: ZzClawTermSidecar,
...
impl TerminalCore {
    ...
    fn new_with_config(cols: u16, rows: u16, config: Config) -> Self {
        ...
        let proxy = ZzClawTermEventProxy::default();
        ...
        Self {
            ...
            term_config: config,
            proxy,
            sidecar: ZzClawTermSidecar::default(),
    ...
    ///
    /// This is for local status/log lines generated by ZzClawTerm itself. Remote
...
fn line_signature(term: &Term<ZzClawTermEventProxy>, line: Line, cols: usize) -> u64 {
...
fn terminal_word_char_at(term: &Term<ZzClawTermEventProxy>, point: Point) -> Option<char> {

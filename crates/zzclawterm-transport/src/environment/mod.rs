...
pub(super) const SHELL_ENV_READER_VARIABLE: &str = "ZZCLAWTERM_SHELL_ENV_READER";
#[cfg(any(unix, windows))]
pub(super) const COMPLETE_SNAPSHOT_SENTINEL_VARIABLE: &str = "__ZZCLAWTERM_ENV_COMPLETE_SENTINEL__";
...
impl ShellEnvironmentCache {
    ...
    async fn load_environment_on_runtime_thread(
        ...
        std::thread::Builder::new()
            .name("zzclawterm-shell-environment".to_string())
            .spawn(move || {

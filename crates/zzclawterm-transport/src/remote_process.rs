...
pub const PROCESS_LIST_UNSUPPORTED_MARKER: &str = "ZZCLAWTERM_PROCESS_UNSUPPORTED";
...
pub const PROCESS_LIST_SCRIPT: &str = r#"sh -s <<'ZZCLAWTERM_PROCESS_SCRIPT'
LC_ALL=C
export LC_ALL

unsupported() {
  echo "ZZCLAWTERM_PROCESS_UNSUPPORTED"
  exit 42
}
    ...
    F: Future<Output = anyhow::Result<T>> + Send + 'static,
{
    let runtime = tokio::runtime::Builder::new_multi_thread()
        .enable_all()
        .thread_name("zzclawterm-ssh-exec")
        .build()

...
///
/// Persistent fields remain owned by `zzclawterm-core`, keeping the transport
...
pub struct SshSessionConfig {
    ...
    pub post_login: Option<zzclawterm_core::models::sessions::ConnectionPostLogin>,
    /// Seconds between SSH keepalive packets. Zero disables keepalive.
    pub keep_alive_interval_secs: u32,
    pub keep_alive_mode: zzclawterm_core::terminal::connection_input::KeepaliveMode,
    pub cols: u16,
    pub rows: u16,
    /// Total terminal pixel width (cols * cell_width). Zero means unknown.
    pub pixel_width: u16,

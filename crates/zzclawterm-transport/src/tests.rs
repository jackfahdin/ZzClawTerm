...
fn run_bash_injection_history_probe(
    ...
    commands.push_str(
        "case $- in *h*) printf '__ZZCLAWTERM_HISTORY_STATE__:enabled\\n' ;; *) printf '__ZZCLAWTERM_HISTORY_STATE__:disabled\\n' ;; esac\nprintf '__ZZCLAWTERM_HISTORY_BEGIN__\\n'\nHISTTIMEFORMAT= builtin history\nprintf '__ZZCLAWTERM_HISTORY_END__\\n'\nexit\n",
    );
...
fn bash_inline_shell_integration_does_not_pollute_enabled_history() {
    for mode in [
        ...
        for leaked in ["ZZCLAWTERM_INJ", "__zzclawterm_", "__zzclaw_bp_"] {
            assert!(

...
use crate::tooltip::ZzClawTooltip;

type ZzClawSettingsSelectHandler = Rc<dyn Fn(SharedString, &mut Window, &mut App)>;
type ZzClawSettingsGroupToggleHandler = Rc<dyn Fn(SharedString, &mut Window, &mut App)>;
...
#[derive(Clone, Debug)]
pub struct ZzClawSettingsNavItem {
    id: SharedString,
    label: SharedString,
    icon_path: SharedString,
}

impl ZzClawSettingsNavItem {
    pub fn new(
...
#[derive(Clone, Debug)]
pub struct ZzClawSettingsNavGroup {
    id: Option<SharedString>,
    title: Option<SharedString>,
    icon_path: Option<SharedString>,
    accent: u32,
    expanded: bool,
    items: Vec<ZzClawSettingsNavItem>,
}

impl ZzClawSettingsNavGroup {
    pub fn new(
        id: impl Into<SharedString>,
    ...
    pub fn standalone(items: impl IntoIterator<Item = ZzClawSettingsNavItem>) -> Self {
        Self {
            id: None,
            title: None,
            icon_path: None,
    ...
    pub fn item(mut self, item: ZzClawSettingsNavItem) -> Self {
        self.items.push(item);
        self
    }

    pub fn items(mut self, items: impl IntoIterator<Item = ZzClawSettingsNavItem>) -> Self {
...
#[derive(IntoElement)]
pub struct ZzClawSettingsLayout {
    id: SharedString,
    groups: Vec<ZzClawSettingsNavGroup>,
    ...
    on_toggle_group: Option<ZzClawSettingsGroupToggleHandler>,
}

impl ZzClawSettingsLayout {
    pub fn new(
        id: impl Into<SharedString>,
        groups: impl IntoIterator<Item = ZzClawSettingsNavGroup>,
        active_item_id: impl Into<SharedString>,
        content: impl IntoElement,
    ) -> Self {
        let groups: Vec<ZzClawSettingsNavGroup> = groups.into_iter().collect();
...
impl RenderOnce for ZzClawSettingsLayout {
    ...
    Some(
        div()
            ...
            .when(compact, |this| {
                ...
                this.tooltip(move |window, cx| ZzClawTooltip::new(title.clone()).build(window, cx))
            })
...
fn settings_nav_item(
    ...
    div()
        ...
        .when(compact, |this| {
            ...
            this.tooltip(move |window, cx| ZzClawTooltip::new(label.clone()).build(window, cx))
        })
        .on_click(move |_: &ClickEvent, window, cx| {

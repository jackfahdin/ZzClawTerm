//! Bridge from ZzClawTerm's persisted theme palette to gpui-kit's theme.
...
mod tests {
    ...
    #[test]
    fn segmented_tab_tokens_follow_zzclawterm_palette() {
        let cx = TestAppContext::single();
    ...
    #[test]
    fn editor_colors_follow_the_zzclawterm_palette() {
        let cx = TestAppContext::single();
    ...
    #[test]
    fn popover_tokens_follow_zzclawterm_palette() {
        let cx = TestAppContext::single();

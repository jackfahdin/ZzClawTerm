use crate::button::{ZzClawButton, ZzClawButtonVariant, ZzClawIconButton};
...
#[derive(IntoElement)]
pub struct ZzClawScrollArea {
    id: SharedString,
    max_height: Option<Pixels>,
    children: Vec<AnyElement>,
}

impl ZzClawScrollArea {
...
impl RenderOnce for ZzClawScrollArea {
...
#[derive(IntoElement)]
pub struct ZzClawUniformListScrollbar {
    id: SharedString,
    handle: UniformListScrollHandle,
}

impl ZzClawUniformListScrollbar {
...
#[derive(IntoElement)]
pub struct ZzClawHorizontalScrollbar {
    id: SharedString,
    handle: ScrollHandle,
}

impl ZzClawHorizontalScrollbar {
...
impl RenderOnce for ZzClawHorizontalScrollbar {
...
impl RenderOnce for ZzClawUniformListScrollbar {
    fn render(self, _window: &mut Window, _cx: &mut App) -> impl IntoElement {
...
pub fn small_button(
    ...
    ZzClawButton::new(id.into(), label.into())
...
pub fn svg_icon_button(
    ...
    ZzClawIconButton::new(id.into(), icon_path)
...
#[cfg(test)]
mod tests {
    use super::{ZzClawHorizontalScrollbar, ZzClawScrollArea};
    use gpui::{
            ...
            div()
                ...
                .child(
                    div()
                        ...
                        .child(ZzClawHorizontalScrollbar::new(
    ...
    impl Render for MaxHeightScrollAreaFixture {
        fn render(&mut self, _: &mut Window, _: &mut Context<Self>) -> impl IntoElement {
            div()
                .w(px(120.))
                .child(
                    ZzClawScrollArea::new("max-height-scroll-area")
                        .max_h(px(60.))
